...
class Level():
    ...
    def levelup(self, scene, ball):
        circuit_grid_model = CircuitGridModel(scene.qubit_num, CIRCUIT_DEPTH)
        ...
        self.circuit = circuit_grid_model.compute_circuit()
        ...
        self.circuit_grid = CircuitGrid(0, ball.screenheight, circuit_grid_model)
        ...
        self.right_box.rect.x = right_sprites.xpos
